...
import com.example.maestromultiplicacion_eduardoescribano.databinding.FragmentConfiguracionBinding;
...
public class ConfiguracionFragment extends Fragment implements Spinner.OnItemSelectedListener,View.OnClickListener{
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.btnFecha){
            ...
            d.show(getParentFragmentManager(), "Mi diálogo Fecha");
    ...
    private void actualizarColores(int color) {
        ...
        botonFecha.setTextColor(Color.WHITE);
